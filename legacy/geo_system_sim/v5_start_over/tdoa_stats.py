...
def three_pass(x_results,y_results):
    ...
    # # Fourth pass
    # try:
    #     H_ppp, xedges_ppp, yedges_ppp = np.histogram2d(x_drefined, y_drefined)
    #     extent_ppp = [xedges_ppp[0], xedges_ppp[-1], yedges_ppp[0], yedges_ppp[-1]]

    #     idx_ppp = np.unravel_index(np.argmax(H_ppp),H_ppp.shape)
    #     x_lower_ppp = xedges_ppp[idx_ppp[0]]
    #     x_upper_ppp = xedges_ppp[idx_ppp[0]+1]
    #     y_lower_ppp = yedges_ppp[idx_ppp[1]]
    #     y_upper_ppp = yedges_ppp[idx_ppp[1]+1]

    #     if DEBUG:
    #         print 'Third Pass'
    #         print 'H_ppp: '
    #         print H_ppp
    #         print "idx_pppp: ", idx_ppp
    #         print "x_lower_ppp: ", x_lower_ppp
    #         print "x_upper_ppp: ", x_upper_ppp
    #         print "y_lower_ppp: ", y_lower_ppp
    #         print "y_upper_ppp: ", y_upper_ppp

    # except:
    #     print 'Fourth pass failed'
    #     print 'probably not enough data'
