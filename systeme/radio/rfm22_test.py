...
class RF(object):
    ...
    def setup_rf(self, fc, hbsel, fb):
        ...
        spi.write(rf22_reg.REG_07_OPERATING_MODE1, rf22_reg.SWRES)
        spi.write(rf22_reg.REG_05_INTERRUPT_ENABLE1, rf22_reg.EN_DISABLE)
        spi.write(rf22_reg.REG_06_INTERRUPT_ENABLE2, rf22_reg.EN_DISABLE)
