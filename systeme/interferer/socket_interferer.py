...
class SocketInterferer(object):
    """
    Socket-based interferer.

    Opens a listening socket and waits for incoming requests and commands.

    """
    
    def __init__(self):
        self.listen_port = 42000
    ...
    def setup_socket(self):
        ...
        if DEBUG:
            print 'Listen on port: ', self.listen_port


    def open_socket(self):
        """
        Open socket and listen for data.
    ...
    def run(self):
        """
        Run the socket-based interferer.
